...
Remove-Module DomainManagement -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\DomainManagement.psd1"
Import-Module "$PSScriptRoot\..\DomainManagement.psm1" -Force
